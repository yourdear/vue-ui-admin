...
var stylus = function () {
  ...
  require.register("functions/url.js", function (module, exports, require) {
    var Compiler = require("../visitor/compiler"), events = require("../renderer").events, nodes = require("../nodes"),
      extname = require("../path").extname, utils = require("../utils");
    var defaultMimes = {
      ".gif": "image/gif",
      ".png": "image/png",
      ".jpg": "image/jpeg",
    ...
    module.exports = function (options) {
      ...
      function fn(url, enc) {
        ...
        url = parse(url);
        var ext = extname(url.pathname), mime = mimes[ext], hash = url.hash || "",
          literal = new nodes.Literal('url("' + url.href + '")'), paths = _paths.concat(this.paths), buf, result;
  ...
  require.register("functions/add-property.js", function (module, exports, require) {
    ...
    (module.exports = function addProperty(name, expr) {
      ...
      var len = block.nodes.length, head = block.nodes.slice(0, block.index),
  ...
  require.register("functions/contrast.js", function (module, exports, require) {
    var utils = require("../utils"), nodes = require("../nodes"), blend = require("./blend"),
    ...
    module.exports = function contrast(top, bottom) {
      ...
      if (1 <= bottom.a) {
        ...
        var onBlack = contrast(top, blend(bottom, new nodes.RGBA(0, 0, 0, 1))),
          onWhite = contrast(top, blend(bottom, new nodes.RGBA(255, 255, 255, 1))), max = Math.max(onBlack, onWhite);
    ...
    (module.exports = function selector() {
      ...
      if (1 == args.length) {
        ...
        if (1 == len) {
          ...
          var SelectorParser = require("../selector-parser"), val = expr.first.string,
  ...
  require.register("functions/tan.js", function (module, exports, require) {
    ...
    module.exports = function tan(angle) {
      ...
      var m = Math.pow(10, 9);
      var sin = Math.round(Math.sin(radians) * m) / m, cos = Math.round(Math.cos(radians) * m) / m,
  ...
  require.register("lexer.js", function (module, exports, require) {
    ...
    function Lexer(str, options) {
      ...
      function comment(str, val, offset, s) {
        var inComment = s.lastIndexOf("/*", offset) > s.lastIndexOf("*/", offset),
          commentIdx = s.lastIndexOf("//", offset), i = s.lastIndexOf("\n", offset), double = 0, single = 0;
    ...
    Lexer.prototype = {
      inspect: function () {
        ...
        var column = this.column, line = this.lineno,
        ...
        if (captures = /^#([a-fA-F0-9]{3})[ \t]*/.exec(this.str)) {
          this.skip(captures);
          var rgb = captures[1], r = parseInt(rgb[0] + rgb[0], 16), g = parseInt(rgb[1] + rgb[1], 16),
            b = parseInt(rgb[2] + rgb[2], 16), color = new nodes.RGBA(r, g, b, 1);
          color.raw = captures[0];
          return new Token("color", color)
        }
      }, rgba: function () {
        ...
        if (captures = /^#([a-fA-F0-9]{4})[ \t]*/.exec(this.str)) {
          this.skip(captures);
          var rgb = captures[1], r = parseInt(rgb[0] + rgb[0], 16), g = parseInt(rgb[1] + rgb[1], 16),
            b = parseInt(rgb[2] + rgb[2], 16), a = parseInt(rgb[3] + rgb[3], 16),
        ...
        if (captures = /^#([a-fA-F0-9]{6})[ \t]*/.exec(this.str)) {
          this.skip(captures);
          var rgb = captures[1], r = parseInt(rgb.substr(0, 2), 16), g = parseInt(rgb.substr(2, 2), 16),
            b = parseInt(rgb.substr(4, 2), 16), color = new nodes.RGBA(r, g, b, 1);
          color.raw = captures[0];
          return new Token("color", color)
        }
      }, rrggbbaa: function () {
        ...
        if (captures = /^#([a-fA-F0-9]{8})[ \t]*/.exec(this.str)) {
          this.skip(captures);
          var rgb = captures[1], r = parseInt(rgb.substr(0, 2), 16), g = parseInt(rgb.substr(2, 2), 16),
            b = parseInt(rgb.substr(4, 2), 16), a = parseInt(rgb.substr(6, 2), 16),
            color = new nodes.RGBA(r, g, b, a / 255);
          color.raw = captures[0];
          return new Token("color", color)
        }
  ...
  require.register("nodes/query.js", function (module, exports, require) {
    ...
    Query.prototype.merge = function (other) {
      var query = new Query, p1 = this.resolvedPredicate, p2 = other.resolvedPredicate, t1 = this.resolvedType,
        t2 = other.resolvedType, type, pred;
      t1 = t1 || t2;
      t2 = t2 || t1;
      if ("not" == p1 ^ "not" == p2) {
        if (t1 == t2) return;
    ...
    Query.prototype.toString = function () {
      var pred = this.predicate ? this.predicate + " " : "", type = this.type || "", len = this.nodes.length,
        str = pred + type;
      if (len) {
  ...
  require.register("nodes/rgba.js", function (module, exports, require) {
    var Node = require("./node"), HSLA = require("./hsla"), functions = require("../functions"),
      adjust = functions.adjust, nodes = require("./index");
  ...
  require.register("nodes/string.js", function (module, exports, require) {
    var Node = require("./node"), sprintf = require("../functions").s, utils = require("../utils"),
      nodes = require("./index");
  ...
  require.register("parser.js", function (module, exports, require) {
    var Lexer = require("./lexer"), nodes = require("./nodes"), Token = require("./token"), units = require("./units"),
  ...
  require.register("renderer.js", function (module, exports, require) {
    var Parser = require("./parser"), Evaluator = require("./visitor/evaluator"),
      Normalizer = require("./visitor/normalizer"), utils = require("./utils"), nodes = require("./nodes"),
  ...
  require.register("utils.js", function (module, exports, require) {
    ...
    exports.formatException = function (err, options) {
      var lineno = options.lineno, column = options.column, filename = options.filename, str = options.input,
        context = options.context || 8, context = context / 2, lines = ("\n" + str).split("\n"),
        start = Math.max(lineno - context, 1), end = Math.min(lines.length, lineno + context),
  ...
  require.register("visitor/evaluator.js", function (module, exports, require) {
    var Visitor = require("./index"), nodes = require("../nodes"), Stack = require("../stack"),
      Frame = require("../stack/frame"), utils = require("../utils"), bifs = require("../functions"),
      dirname = require("../path").dirname, colors = require("../colors"), units = require("../units");
    ...
    Evaluator.prototype.populateGlobalScope = function () {
      ...
      Object.keys(colors).forEach(function (name) {
        var color = colors[name], rgba = new nodes.RGBA(color[0], color[1], color[2], color[3]),
    ...
    Evaluator.prototype.visitEach = function (each) {
      this.ret++;
      var expr = utils.unwrap(this.visit(each.expr)), len = expr.nodes.length, val = new nodes.Ident(each.val),
        key = new nodes.Ident(each.key || "__index__"), scope = this.currentScope, block = this.currentBlock, vals = [],
        self = this, body, obj;
      this.ret--;
    ...
    Evaluator.prototype.visitBinOp = function (binop) {
      ...
      this.ret++;
      var op = binop.op, left = this.visit(binop.left),
    ...
    Evaluator.prototype.visitProperty = function (prop) {
      var name = this.interpolate(prop), fn = this.lookup(name), call = fn && "function" == fn.first.nodeName,
        literal = ~this.calling.indexOf(name), _prop = this.property;
    ...
    Evaluator.prototype.mixinObject = function (object) {
      var Parser = require("../parser"), root = this.root, str = "$block " + object.toBlock(),
        parser = new Parser(str, utils.merge({root: block}, this.options)), block;
      try {
        block = parser.parse()
      } catch (err) {
